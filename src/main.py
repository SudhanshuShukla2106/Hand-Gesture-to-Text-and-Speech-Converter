...
def HomePage():
	...
	def contactus():
		...
		homebtn.place(x=700, y = 40)
		contactusbtn = Button(cntct,text = "About Project",font = ("Agency FB",16,"bold"), width=12, relief = FLAT,padx=1, bd = 0, borderwidth='0',bg="#787A91",fg="#0F044C",activebackground = "#EEEEEE",activeforeground = "#141E61",command=aboutus)
		contactusbtn.place(x=870,y = 40)
	...
	def VideoMode():
		...
		Label(predict_stream, text="Predicted String: ", font = ("Agency FB",16,"bold")).place(x=200, y=600)
